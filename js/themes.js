// js/themes.js - Оптимізована версія з усуненням дублювання

// ====================== ФРАЗЕОЛОГІЗМИ - ВСІ УНІКАЛЬНІ ПИТАННЯ ======================
...
// Функція для отримання випадкових питань (перемішування методом Fisher-Yates)
function getRandomQuestions(count = 16) {
...
// ====================== ГЕНЕРАЦІЯ 14 ТЕМ ФРАЗЕОЛОГІЗМІВ ======================
// Динамічно створюємо теми frazeologizmy1 - frazeologizmy14
for (let i = 1; i <= 14; i++) {
    themes[`frazeologizmy${i}`] = getRandomQuestions(16);
}
